...
Route::group(['prefix' => 'admin', 'middleware' => ['manager', 'locale'], 'namespace' => 'Admin'], function() {
    ...
    Route::post('seen-notify/{id}', 'NotifyController@seen')->name('seen.notify');
    Route::get('all-notify', 'NotifyController@index')->name('all.notify');
...
Route::group(['prefix' => '/', 'middleware' => 'locale'], function() {
    ...
    Route::post('statistical', 'OrderDetailController@statistical')->name('statistical')->middleware('manager');
    ...
    Route::get('order-success', 'OrderDetailController@orderSuccess')->name('product.order_success')->middleware('manager');
